<?php
    ...
    <body>  
     <input type="hidden" id="cookies" name="cookies" value="<?php
                        ...
                        {              
                          ...
                          <?php
                                   ...
                                   if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["btnAdd"])) {
                                        ...
                                        $sql = "INSERT INTO tblqueue (searchCode, Code, Title,sess) VALUES (?, ?, ?,?)";
                                   
                                        // Prepare and bind the statement
                                        $stmt = $conn->prepare($sql);
                                        $stmt->bind_param("ssss", $searchCode, $code, $title,$cookie);
